...
export default [
  {
    ...
    id: 0,
    jargon: "Whatever your rug's origin, you can trust it's cleaning to our experts.",
    imageUrl:
      `${rug}`,
    description:
    ...
    shipping:
      ...
      clickit: "See How We Do It"
  },
  {
    name: "Installed Carpet Cleaning",
    id: 1,
    jargon: "Wool or synthetic, we're experienced at restoring your carpet's appearance.",
    imageUrl:
       `${dogandbaby}`,
    description:
  ...
  },
  {
    ...
    id: 2,
    jargon: "Leave your stone, tile, and grout cleaning and protective sealing to us.",
    imageUrl:
       `${dogandbaby}`,
    description:
  ...
  {
    name: "Fabric & Leather Upholstery Cleaning",
    id: 3,
    jargon: "Our meticulous cleaning will recapture your furniture's appearance.",
    imageUrl:
     `${couch}`,
    description:
  ...
  {
    name: "Carpet Edge Treatments",
    id: 4,
    jargon: "Carpet binding, serging, and fringing - the finishing touches by Good Guys.",
    imageUrl:
     `${rug}`,
    description:
  ...
  {
    name: "Hand Rug Repair and Reweaving",
    id: 5,
    jargon: "Our repair experts can restore your rug's appearance and value." ,
    imageUrl:
     `${rug}`,
    description:
